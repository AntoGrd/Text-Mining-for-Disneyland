...
tab_lieu=pd.DataFrame({'Ville':tab_ville[0],'Pays':tab_pays[0],'Contient':tab_continent[0]})
...
tab_date_avis['Annee_avis'].value_counts()
#table Date_sejour
...
lieu=tab_lieu['Ville']+tab_lieu['Pays']+tab_lieu['Contient'].apply(str)
